<div id="help-template" class="outer">
    <h1 class="head">Help:
        <a class="ui-corner-all tooltip" href="<{$xoops_url}>/modules/assessment/admin/index.php"
           title="Back to the administration of Assessment"> Assessment
            <img src="<{xoAdminIcons home.png}>"
                 alt="Back to the Administration of Assessment">
        </a></h1>

    <h4 class="odd">Description</h4>

    <p class="even">This module enables you to create questions, answers and group them all together to create an exam/assessment<br> <br>
    </p>
    ...
    <a href="https://xoops.gitbook.io/xoops-operations-guide/" target="_blank">Chapter 2.8 of our XOOPS Operations Manual</a><br> <br>
