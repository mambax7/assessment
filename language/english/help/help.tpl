<div id="help-template" class="outer">
    ...
    <p class="even">This module is for conducting online tests/quizzes/exams in school<br> <br>
    </p>
    ...
    <p class="even">
        Tutorial has been started, but we might need your help! Please check out the status of the tutorial <a href="https://www.gitbook.com/book/xoops/assessment-tutorial/" target="_blank">here </a>.
        <br><br>To contribute to this Tutorial, <a href="https://github.com/XoopsDocs/assessment-tutorial/" target="_blank">please fork it on GitHub</a>.
